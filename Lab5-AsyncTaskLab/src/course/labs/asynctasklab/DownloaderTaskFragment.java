...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Integer> intParam= bundle.getIntegerArrayList("friends");
		Integer[] param = new Integer[intParam.size()];
		int j = 0;
		for (Integer i : intParam) {
			param[j++] = Integer.valueOf(i);
		}
		
		//Integer[] param = {R.raw.lgaga, R.raw.rblack, R.raw.tswift};
        
        
        
		// TODO: Start the DownloaderTask 
		downloaderTask.execute(param);
